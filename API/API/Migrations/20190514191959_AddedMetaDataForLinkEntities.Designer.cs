...
namespace CLERP.API.Migrations
{
    ...
    [Migration("20190514191959_AddedMetaDataForLinkEntities")]
    partial class AddedMetaDataForLinkEntities
    {
            ...
            modelBuilder.Entity("CLERP.API.Domain.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("e0858b5c-9f01-4d02-87ba-073b5a8684c9"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(1822),
                            Description = "Employee from the logistics department",
                            LastModified = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(3102),
                            LastModifiedBy = "system",
                            Name = "Logistic"
                        },
                        new
                        {
                            Guid = new Guid("8e1fbbd8-18a6-4f49-9f79-c0a2986c903d"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4414),
                            Description = "Employee from the finances department",
                            LastModified = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4432),
                            LastModifiedBy = "system",
                            Name = "Finance"
                        },
                        new
                        {
                            Guid = new Guid("d37edd3e-b87c-4378-9c79-8daec7c3f64e"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4454),
                            Description = "Employee from the purchases department",
                            LastModified = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4457),
                            LastModifiedBy = "system",
                            Name = "Purchase"
                        },
                        new
                        {
                            Guid = new Guid("03c77024-46b1-4f9c-b00f-0ab84cda6bda"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4466),
                            Description = "Administrators of the app",
                            LastModified = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4468),
                            LastModifiedBy = "system",
                            Name = "SysAdmin"
                        },
                        new
                        {
                            Guid = new Guid("660f23ed-608f-4dc6-b7e3-f1ea6236d0ab"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4474),
                            Description = "Employee from the sales department",
                            LastModified = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4477),
                            LastModifiedBy = "system",
                            Name = "Sale"
                        },
                        new
                        {
                            Guid = new Guid("bdefb7d6-89e4-400d-a731-bb860cd2c2fc"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4483),
                            Description = "Employee from the management",
                            LastModified = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4485),
                            LastModifiedBy = "system",
                            Name = "Management"
                        },
                        new
                        {
                            Guid = new Guid("ef80c023-deb1-4e85-8614-b184a5ff5252"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4490),
                            Description = "Employee from the hr department",
                            LastModified = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4492),
                            LastModifiedBy = "system",
                            Name = "HR"
                        },
                        new
                        {
                            Guid = new Guid("6f61fcc9-6607-4fae-b7f8-bf596d1d186c"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4498),
                            Description = "Employee from the production department",
                            LastModified = new DateTime(2019, 5, 14, 21, 19, 59, 428, DateTimeKind.Local).AddTicks(4503),
                            LastModifiedBy = "system",
                            Name = "Production"
                        });
                });
