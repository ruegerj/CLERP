            ...
            modelBuilder.Entity("CLERP.API.Domain.Models.Department", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("7c1992fb-3af8-4770-bfd1-1386f978772e"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(1786),
                            Description = "The management of the firm",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(2685),
                            LastModifiedBy = "system",
                            Title = "Management"
                        },
                        new
                        {
                            Guid = new Guid("8ba74c09-bad5-4f5c-bb66-feeed5a457c4"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4595),
                            Description = "The finance department of the firm",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4607),
                            LastModifiedBy = "system",
                            Title = "Finance"
                        },
                        new
                        {
                            Guid = new Guid("be310a6c-ee1c-40c3-8d0c-079ca2e9cf9f"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4628),
                            Description = "The hr department of the firm",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4631),
                            LastModifiedBy = "system",
                            Title = "HR"
                        },
                        new
                        {
                            Guid = new Guid("8124e2ac-514f-41fc-a4e5-d254ad47bb86"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4635),
                            Description = "The sales department of the firm",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4637),
                            LastModifiedBy = "system",
                            Title = "Sales"
                        },
                        new
                        {
                            Guid = new Guid("f50e0988-4a1e-4b8b-9134-86fec6a2d107"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4640),
                            Description = "The purchase department of the firm",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4642),
                            LastModifiedBy = "system",
                            Title = "Purchase"
                        },
                        new
                        {
                            Guid = new Guid("7634b52c-8746-4fe5-b8db-aa070a63b22a"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4647),
                            Description = "The logistics department of the firm",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4650),
                            LastModifiedBy = "system",
                            Title = "Logistic"
                        },
                        new
                        {
                            Guid = new Guid("63e64701-69f4-45fc-8a0c-77127716bc7b"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4653),
                            Description = "The production department of the firm",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 154, DateTimeKind.Local).AddTicks(4655),
                            LastModifiedBy = "system",
                            Title = "Production"
                        });
                });
            ...
            modelBuilder.Entity("CLERP.API.Domain.Models.Role", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Guid = new Guid("70890c67-68d1-485a-8de8-3baf45ffb357"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(881),
                            Description = "Employee from the logistics department",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(906),
                            LastModifiedBy = "system",
                            Name = "Logistic"
                        },
                        new
                        {
                            Guid = new Guid("0929a88f-a53a-426c-95a8-51487b9860c8"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1779),
                            Description = "Employee from the finances department",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1787),
                            LastModifiedBy = "system",
                            Name = "Finance"
                        },
                        new
                        {
                            Guid = new Guid("1493814e-345a-4e38-ba72-2f8f3bf8261e"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1798),
                            Description = "Employee from the purchases department",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1800),
                            LastModifiedBy = "system",
                            Name = "Purchase"
                        },
                        new
                        {
                            Guid = new Guid("0d9b6fcf-37bf-4574-8177-fb3102a972d0"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1803),
                            Description = "Administrators of the app",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1805),
                            LastModifiedBy = "system",
                            Name = "SysAdmin"
                        },
                        new
                        {
                            Guid = new Guid("be9a27d8-e006-4d40-870c-6895199ba4e5"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1808),
                            Description = "Employee from the sales department",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1810),
                            LastModifiedBy = "system",
                            Name = "Sale"
                        },
                        new
                        {
                            Guid = new Guid("9ed454a5-f135-4fbd-9d54-39552d5404b0"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1848),
                            Description = "Employee from the management",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1851),
                            LastModifiedBy = "system",
                            Name = "Management"
                        },
                        new
                        {
                            Guid = new Guid("ce030785-9c08-4fc6-8e40-9cc22490cbfc"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1854),
                            Description = "Employee from the hr department",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1856),
                            LastModifiedBy = "system",
                            Name = "HR"
                        },
                        new
                        {
                            Guid = new Guid("4e6a1923-343a-4066-917b-cecf1d2543d5"),
                            CreatedBy = "system",
                            Creation = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1859),
                            Description = "Employee from the production department",
                            LastModified = new DateTime(2019, 5, 15, 22, 49, 39, 184, DateTimeKind.Local).AddTicks(1861),
                            LastModifiedBy = "system",
                            Name = "Production"
                        });
                });
